...
function Projects() {
  return (
    ...
    <p><a href="https://github.com/nikshitha1312/Endangered_Species" target="_blank">View Project on GitHub</a></p>
      </div>
      <div className={styles.project}>
    ...
    <p><a href="https://github.com/nikshitha1312/resume-website-project" target="_blank">View Project on GitHub</a></p>
      </div>
      <div className={styles.project}>
        <h3>TripMate</h3>
